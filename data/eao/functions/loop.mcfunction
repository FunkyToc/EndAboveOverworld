...
execute if score McVersion fktool matches ..11499 run function eao:system/check_players_1.13
execute if score McVersion fktool matches 11500.. run function eao:system/check_players_1.15

# items and mobs fall
execute if score AffectEntities EAO_Option matches 1 if score McVersion fktool matches ..11499 run function eao:system/check_entities_1.13
