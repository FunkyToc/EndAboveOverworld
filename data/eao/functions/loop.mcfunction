...
execute if score McVersion fktool matches ..11400 run function eao:check_players_1.13
execute if score McVersion fktool matches 11500.. run function eao:check_players_1.15
# items and mobs fall
execute if score McVersion fktool matches ..11400 if score EaoAffectEntities EAO_ypos matches 1 run function eao:check_entities_1.13
